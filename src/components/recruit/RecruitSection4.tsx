    ...
    <>
      <div className='flex flex-col items-center h-[774px] pt-[273px] justify-center box-border bg-black w-full'>
        ...
        <div className='flex flex-col h-[774px] items-center justify-center relative pt-[57px] gap-[100px]'>
          ...
          <div className='relative inline-flex rounded-full p-[3px] overflow-hidden w-[214px] h-[73px] box-border'>
            <div
            ...
            />
            <button className='relative z-20 flex items-center justify-center w-[208px] h-[67px] rounded-full bg-black text-gray-300 hover:bg-gray-800 px-8 py-3 text-lg'>
      ...
      <div className='relative w-full h-[466px] overflow-hidden'>
        <Image src='/images/png/RecruitBottom.png' alt='리크루트 바텀이미지' fill className='object-cover' priority />
      </div>
    </>
  );
}
